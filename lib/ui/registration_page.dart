...
Future<void> register(String firstName, String lastName, String email, String pass) async {
  final url = Uri.parse('http://localhost/semester_6_BE/registration.php'); // Replace with the URL of your registration script
